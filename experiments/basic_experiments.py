...
if __name__ == "__main__":
    ...
    experiment2_diffcp_result = experiment2.cp_grad_desc(step_size=1e-5, num_iter=500)
    print("=== starting LS equality constrained diffqcp experiment ===")
    experiment2_diffqcp_result = experiment2.qcp_grad_desc(step_size=1e-5, num_iter=500)
